...
/*The macro AIRO_KEY_CAPTOUCH_NUMBER_USER_CONFIG is used to configure the numebr of captouch key. If HAL_CPT_FEATURE_4CH is defined, the value must be between 1 and 4
or the value must be between 1 and 8. If this macro is not defined, the the numebr of captouch key is 4 or 8 according to macro HAL_CPT_FEATURE_4CH.
*/
