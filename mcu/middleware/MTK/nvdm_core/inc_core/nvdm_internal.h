...
typedef struct {
    ...
    nvdm_data_item_type_t type;     /* offset: 11, len: 1; display type of data item, it can be type of binary/hex/decimal/string/structure */
...
} nvdm_dcll_t;    /* Doubly Circular Linked List */
