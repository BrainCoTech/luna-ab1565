...
###############################################################################
ifeq ($(MTK_RACE_DUAL_CMD_ENABLE),y)
...
###################################################
# Sources
RACE_CMD_SRC = middleware/MTK/race_cmd
...
CFLAGS += -I$(SOURCE_DIR)/middleware/MTK/race_cmd/inc/lpcomm
CFLAGS += -I$(SOURCE_DIR)/middleware/MTK/race_cmd/inc/cfu
