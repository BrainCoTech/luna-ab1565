...
typedef struct {
    S16 ld_thrd;
    U16 RXIN_TXREF_DELAY;
    S16 DIGITAL_GAIN;
} anc_leakage_compensation_parameters_nvdm_t;

typedef struct {
    anc_leakage_compensation_parameters_nvdm_t nvdm_param;
    uint32_t report_thd;
    uint32_t no_response_thd;
} anc_leakage_compensation_parameters_mcu2dsp_t;
