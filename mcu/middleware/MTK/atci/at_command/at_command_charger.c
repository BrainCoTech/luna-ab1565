...
#elif ((PRODUCT_VERSION == 1552) || defined(AM255X) || (PRODUCT_VERSION == 2822))
#include "FreeRTOS.h"
#include "task.h"
#include <string.h>
#include <ctype.h>
...
#endif
        }else if(strncmp(parse_cmd->string_ptr, "AT+ECHAR=CC,", 12) == 0) {
/*            int input_addr = 0;
            char *end_pos = NULL;
            end_pos = strchr(parse_cmd->string_ptr, ',');
            end_pos++;
            ...
            pmu_set_charger_current(input_addr);
*/
