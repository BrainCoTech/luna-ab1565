...
#if defined HAL_CHARGER_MODULE_ENABLED && defined MTK_BATTERY_MANAGEMENT_ENABLE
...
#if defined(HAL_ADC_MODULE_ENABLED) && (PRODUCT_VERSION == 7686) || (PRODUCT_VERSION == 2822) || (PRODUCT_VERSION == 1565)
...
#if (PRODUCT_VERSION == 2523 || PRODUCT_VERSION == 2533 || PRODUCT_VERSION == 3335 || PRODUCT_VERSION == 2625 || PRODUCT_VERSION == 1552 || PRODUCT_VERSION == 2811 || defined(AM255X) || (PRODUCT_VERSION == 2822) || (PRODUCT_VERSION == 1565))
...
#if (PRODUCT_VERSION == 2552 || PRODUCT_VERSION == 1552 || PRODUCT_VERSION == 2811 || PRODUCT_VERSION == 2822 || PRODUCT_VERSION == 1565)
extern atci_status_t atci_cmd_hdlr_crystal_trim(atci_parse_cmd_param_t *parse_cmd);
#endif
...
#if (PRODUCT_VERSION == 2523 || PRODUCT_VERSION == 2533 || PRODUCT_VERSION == 3335 || PRODUCT_VERSION == 2625 || PRODUCT_VERSION == 1552 || PRODUCT_VERSION == 2811 || PRODUCT_VERSION == 2822 || PRODUCT_VERSION == 1565 || defined(AM255X))
#ifdef HAL_SLEEP_MANAGER_ENABLED
