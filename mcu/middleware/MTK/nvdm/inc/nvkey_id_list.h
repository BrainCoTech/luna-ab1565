...
typedef enum
{
    ...
    NVKEYID_CUSTOMER_PRODUCT_INFO_SN          	   	   = 0xFC00,
    NVKEYID_CUSTOMER_PRODUCT_INFO_BAT_SN          	   = 0xFD00,
    NVKEYID_CUSTOMER_PRODUCT_INFO_TWS_L_SN             = 0xFD20,
    NVKEYID_CUSTOMER_PRODUCT_INFO_TWS_R_SN             = 0xFD40,
} NVKey_ID_list;
