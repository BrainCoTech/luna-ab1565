...
/*
 *   Input : Set addr_base which you want to monitor
 *         : Set NULL to disable to monitor
 */
void pka_dwt_requsest_watchpoint(uint32_t addr_base)
{
    hal_dwt_request_watchpoint(HAL_DWT_1, addr_base, 2, WDE_DATA_WO);
}
