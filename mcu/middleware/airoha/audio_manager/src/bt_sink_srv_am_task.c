...
bt_sink_srv_am_result_t audio_nvdm_configure_init(void)
{
    ...
    if ((audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[0] != 0x02) ||
        (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[1] != 0x02) ||
        (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[2] != 0x02) ||
        (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[3] != 0x02) ||
        (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[4] != 0x02) ||
        (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[5] != 0x02)) {
