    ...
    switch (Detach_MIC_Select) {
        case 0x00:
            mult_vol_cfg->digital_MIC0_L = pNvdmDetachMicVol->Detach_MIC_Digital_Vol;
                switch (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[0]) {
                case 0x00: //ACC_10K
        ...
        case 0x01:
            ...
            if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
                ...
                switch (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[1]) {
                case 0x00: //ACC_10K
                    if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
        ...
        case 0x02:
            if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
                ...
                switch (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[2]) {
                case 0x00: //ACC_10K
                    if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
        ...
        case 0x03:
            if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
                ...
                switch (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[3]) {
                case 0x00: //ACC_10K
                    if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
        ...
        case 0x04:
            if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
                ...
                switch (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[4]) {
                case 0x00: //ACC_10K
                    if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
        ...
        case 0x05:
            if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
                ...
                switch (audio_nvdm_HW_config.adc_dac_config.ADDA_Analog_MIC_Mode[5]) {
                case 0x00: //ACC_10K
                    if (audio_nvdm_HW_config.voice_scenario.Voice_Input_Path == 0x04) {
