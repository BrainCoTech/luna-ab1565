...
typedef struct  {
    ...
    U8 sample_sequence;       /* Sameple sequence of this SDU interval Ex:0,1,2... */ /* not used */
...
audio_transmitter_status_t bt_audio_dongle_set_runtime_config_playback(
    audio_transmitter_config_t *config,
    audio_transmitter_runtime_config_type_t runtime_config_type,
    audio_transmitter_runtime_config_t *runtime_config,
    mcu2dsp_audio_transmitter_runtime_config_param_t *runtime_config_param);
audio_transmitter_status_t bt_audio_dongle_get_runtime_config(
