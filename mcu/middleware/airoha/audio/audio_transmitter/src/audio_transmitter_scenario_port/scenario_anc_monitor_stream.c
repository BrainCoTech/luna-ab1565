...
void audio_transmitter_anc_monitor_open_playback(audio_transmitter_config_t *config, mcu2dsp_open_param_t *open_param)
{
    ...
    if ((open_param->stream_in_param.afe.audio_device2 == open_param->stream_in_param.afe.audio_device) &&
        (open_param->stream_in_param.afe.audio_interface2 == open_param->stream_in_param.afe.audio_interface)){
    ...
    if ((open_param->stream_in_param.afe.audio_device3 == open_param->stream_in_param.afe.audio_device1) &&
        (open_param->stream_in_param.afe.audio_interface3 == open_param->stream_in_param.afe.audio_interface1)){
