...
#endif
    {FUNC_RX_NR_SWB,          {NVKEY_DSP_PARA_SWB_TX_VO_CPD, NVKEY_DSP_PARA_SWB_RX_VO_CPD, NVKEY_DSP_PARA_POSITIVE_GAIN, NVKEY_DSP_PARA_PLC, NVKEY_DSP_PARA_VOICE_TX_AGC, NVKEY_DSP_PARA_VOICE_SWB_RX_AGC, ECNR_SWB_NVKEY_LIST, NVKEY_END} },/*0x6C FUNC_RX_NR_SWB,               */
