...
atci_status_t atci_cmd_hdlr_capid(atci_parse_cmd_param_t *parse_cmd)
{
    ...
    switch (parse_cmd->mode) {
        case ATCI_CMD_MODE_EXECUTION:
            ...
            snprintf((char *)resonse.response_buf, sizeof(resonse.response_buf), "DCXO MODULE not ENABLED\r\n");
        ...
        default :
            ...
            resonse.response_len = strlen((char *)resonse.response_buf);
            resonse.response_flag |= ATCI_RESPONSE_FLAG_APPEND_ERROR; // ATCI will help append "ERROR" at the end of response buffer
            atci_send_response(&resonse);
            break;
    }
