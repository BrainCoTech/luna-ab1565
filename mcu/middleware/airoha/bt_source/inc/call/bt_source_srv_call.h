...
#define BT_SOURCE_SRV_CALL_VCF_100           100U
#define BT_SOURCE_SRV_CALL_VCF_50            50U
#define BT_SOURCE_SRV_CALL_VCF_15            15U
typedef uint32_t bt_source_srv_call_vcf_t;   /* VCF:volume conversion factorial */
