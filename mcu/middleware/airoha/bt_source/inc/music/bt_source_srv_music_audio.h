...
#define BT_SOURCE_SRV_MUSIC_AUDIO_PLAY_TYPE_NONE              0x00
#define BT_SOURCE_SRV_MUSIC_AUDIO_PLAY_TYPE_CODEC             0x01
#define BT_SOURCE_SRV_MUSIC_AUDIO_PLAY_TYPE_TRANSMITTER_UL    0x02
#define BT_SOURCE_SRV_MUSIC_AUDIO_PLAY_TYPE_TRANSMITTER_DL    0x03
typedef uint8_t bt_source_srv_music_audio_play_t;
