...
bool bt_sink_srv_music_is_local_asi_device(void *bt_addr, bool *is_local_asi)
{
    ...
    *is_local_asi = false;
    bt_sink_srv_report_id("remote_addr--0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x", 6,remote_addr[0], remote_addr[1], remote_addr[2], remote_addr[3], remote_addr[4], remote_addr[5]);
