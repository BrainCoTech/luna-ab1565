...
#define BT_SINK_SRV_MUSIC_A2DP_HF_INTERRUPT                 (1 << 3)   /**< HF interrupt A2DP, but no avrcp pause status change */
...
#define BT_SINK_SRV_MUSIC_GAME_FLAG                         (1 << 8)   /*< If this flag is set, it means it`s on playing gaming*/
#endif
