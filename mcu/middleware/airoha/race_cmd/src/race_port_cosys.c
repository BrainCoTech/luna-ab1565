...
#ifndef AIR_LOW_LANTENCY_MUX_ENABLE
...
{
    RACE_LOG_MSGID_I("[race_cosys]active cosys port is %d.", g_race_cosys_info.cosys_port);
...
{
    RACE_LOG_MSGID_I("[race_emcu]active emcu port is %d.", g_race_cosys_info.emcu_port);
