...
#define HW_SYSRAM_PRIVATE_MEMORY_RESERVED_START (HW_SYSRAM_PRIVATE_RECORD_LEAVE_DPD_TIME_START + HW_SYSRAM_PRIVATE_RECORD_LEAVE_DPD_TIME_LEN)
#define HW_SYSRAM_PRIVATE_MEMORY_RESERVED_LEN   0x510
