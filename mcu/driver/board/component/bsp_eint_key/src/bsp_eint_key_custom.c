...
static void bsp_eintkey_rtc_gpio_driver_init(uint32_t key_index, uint32_t pin_num, uint32_t key_data, uint32_t active_level)
{
...
#define BSP_EINTKEY_RTC_GPIO_DRIVER_INIT(key_index) \
    bsp_eintkey_rtc_gpio_driver_init(key_index, BSP_EINTKEY##key_index##_PIN, BSP_EINT_KEY_DATA##key_index, BSP_EINTKEY##key_index##_ACTIVE_LEVEL)
#else
#define BSP_EINTKEY_RTC_GPIO_DRIVER_INIT(key_index)
#endif
...
static void bsp_eintkey_driver_init(uint32_t key_index, uint32_t *available_key_nums, uint32_t key_data, uint32_t pin_num, uint32_t eint_mode, uint32_t eint_num, uint32_t active_level)
{
...
#define BSP_EINTKEY_DRIVER_INIT(key_index, available_key_nums)\
    bsp_eintkey_driver_init(key_index, &available_key_nums, BSP_EINT_KEY_DATA##key_index, \
