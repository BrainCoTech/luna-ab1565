...
#define SHARE_BUFFER_BT_AUDIO_USB_OUT_SIZE   (10240) /* Support 48K/24bit/2ch/15ms/2-process */
#endif
...
#endif
#if defined (AIR_ULL_AUDIO_V2_DONGLE_ENABLE) || defined (AIR_BLE_AUDIO_DONGLE_ENABLE) || defined(AIR_WIRELESS_MIC_RX_ENABLE) || defined(AIR_BT_AUDIO_DONGLE_ENABLE)
