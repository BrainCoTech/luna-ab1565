...
int32_t hal_emi_dynamic_clock_switch(emi_clock clock,hal_emi_clock_frq target_freq);
void mtk_psram_half_sleep_enter(void);
void mtk_psram_half_sleep_exit(void);
void EMI_Setting_restore(void);
void EMI_Setting_Save(void);
int8_t custom_setEMI(void);
int8_t custom_setAdvEMI(void);
void emi_mask_master(void);
void emi_unmask_master(void);
