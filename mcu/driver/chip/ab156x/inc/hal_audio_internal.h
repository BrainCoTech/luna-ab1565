...
typedef struct {
    ...
    hal_audio_stream_info_t stream_out[3];
} audio_common_t;
...
typedef struct HAL_DSP_PARA_AU_AFE_AUDIO_SCENARIO_s {
    ...
    */
    ...
    /*
        ...
        2, fix 96000Hz
    */
    uint8_t Audio_I2S_Master_Sampling_Rate[4];
...
typedef struct HAL_DSP_PARA_AU_AFE_VOICE_SCENARIO_s {
    ...
    */
    ...
    /*
        ...
        2, fix 96000Hz
    */
    uint8_t Voice_I2S_Master_Sampling_Rate[4];
...
typedef struct HAL_DSP_PARA_AU_AFE_ADC_DAC_CONFIG_s {
    ...
    /*  0x0: 1.8V,
        ...
        0x7: 2.55V,
    */
    uint8_t ADDA_Voice_Bias_Level[5];
    ...
    */
    ...
    /*
        ...
        0x2: DCC,
    */
    uint8_t ADDA_Analog_MIC_Mode[6];

    /*  0x0: MEMS,
        0x1: ECM Differential,
        0x2: ECM Single,
    */
    uint8_t ADDA_Analog_MIC_VIN_PUD[6];
...
typedef struct HAL_DSP_PARA_AU_AFE_DMIC_CONFIG_s {
    /*  0x0: GPIO_DMIC0,
        ...
        0x7: ANA_DMIC5,
    */
    uint8_t DMIC_Digital_MIC_Pin_Sel[3];
    /*
...
typedef struct HAL_DSP_PARA_AU_AFE_I2SM_CONFIG_s {
    /*  0x0: Format_Right_Justified,
        ...
        0x2: Format_I2S,
    */
    uint8_t I2S_Master_Format[4];

    /*  0x0: 16_bit,
        0x1: 32_bit,
    */
    uint8_t I2S_Master_Word_length[4];

    /*  0x0: disable,
        0x1: enable,
    */
    uint8_t I2S_Master_Low_jitter[4];
