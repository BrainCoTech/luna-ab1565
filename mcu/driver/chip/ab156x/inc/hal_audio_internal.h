...
typedef struct HAL_DSP_PARA_AU_AFE_I2SM_CONFIG_s {
    ...
    */
    ...
    /*  0x0: disable,
        0x1: enable,
    */
    //uint8_t I2S_Master_tx_swap;


    /*  0x0: disable,
        0x1: enable,
    */
    //uint8_t I2S_Master_rx_swap;

    /*  0x0: disable,
        0x1: enable,
        0x2: keep_clock,
    */
    //uint8_t I2S_Master_mclk;

    /*
        divider_value,
    */
    //uint8_t I2S_Master_mclk_divider;

    uint8_t I2S_Master_Reserved[4];
