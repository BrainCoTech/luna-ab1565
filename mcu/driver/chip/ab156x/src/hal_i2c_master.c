...
static i2c_transfer_config_t       * const s_i2c_q_buf[HAL_I2C_MASTER_MAX] = {s_i2c0_q_buf, s_i2c1_q_buf, s_i2c2_q_buf, (i2c_transfer_config_t *) NULL};
...
hal_i2c_status_t    hal_i2c_master_init(hal_i2c_port_t i2c_port, hal_i2c_config_t *i2c_config)
{
    ...
    i2c_config_speed(i2c_port, i2c_speed_enum_to_dec(i2c_config->frequency));
...
hal_i2c_status_t hal_i2c_master_get_running_status(hal_i2c_port_t i2c_port, hal_i2c_running_status_t *running_status)
{
    ...
    running_status->running_status = (hal_i2c_running_type_t) (i2c_op_ioctl(i2c_port, I2C_IOCTRL_GET_BUSY_STAT, 0));
    return HAL_I2C_STATUS_OK;
}
...
ATTR_TEXT_IN_TCM static hal_i2c_status_t    _hal_i2c_config_transfer(hal_i2c_port_t i2c_port, i2c_transfer_config_t *config)
{
    ...
    if (config->speed != HAL_I2C_FREQUENCY_MAX) {
        i2c_config_speed(i2c_port, i2c_speed_enum_to_dec(config->speed));
    }
 ...
 /*step 1: find free item */
    ...
    if (i2c_op_ioctl(i2c_port, I2C_IOCTRL_GET_BUSY_STAT, 0) == 0) {
        if (queue_top(&priv_info->i2c_queue, (int *) &temp) >= 0) {
            ...
            if((priv_info->hw_state & I2C_HW_STATE_USED_MASK) != I2C_HW_STATE_USED_NORMAL){
                priv_info->hw_state &= ~I2C_HW_STATE_DEV_BUSY_MASK;
            }
        }
    }
