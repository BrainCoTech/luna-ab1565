...
bool spi_master_dma_transfer_settings(hal_spi_master_port_t master_port, bool *continue_pause_mode, bool *is_continue, bool is_write, bool *le)
{
    bool loop_end;
...
void spi_master_start_transfer_dma(hal_spi_master_port_t master_port, bool is_continue, bool is_write)
{
    ...
    spi_master_dma_transfer_settings(master_port, &continue_pause_mode, &is_continue, is_write, NULL);
}
...
void spi_master_start_transfer_dma_blocking(hal_spi_master_port_t master_port, bool is_write)
{
    ...
    do {
        if (!spi_master_dma_transfer_settings(master_port, &continue_pause_mode, &is_continue, is_write, &loop_end)) {
            return;
        }
