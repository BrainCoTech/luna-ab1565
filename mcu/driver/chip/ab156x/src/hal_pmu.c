...
#elif defined AIR_BTA_PMIC_G2_LP
#else
    log_hal_msgid_info("Error pmu_set_audio_mode", 0);
#endif
}
...
#elif defined AIR_BTA_PMIC_G2_LP
#else
    log_hal_msgid_info("Error pmu_enable_micbias", 0);
#endif
...
#elif defined AIR_BTA_PMIC_G2_LP
#else
    log_hal_msgid_info("Error pmu_set_cap_wo_vbus", 0);
#endif
}
/*==========[Module Function]==========*/
...
void pmu_dump_nvkey(void)
{
    ...
    pmu_dump_nvkey_lp();
#else
    log_hal_msgid_info("Error pmu_dump_nvkey", 0);
#endif
#endif
}
...
uint32_t pmu_1wire_get_vbus_uart_volt(void)
{
    ...
    volt = pmu_auxadc_get_channel_value(PMU_AUX_VCHG);
#else
    log_hal_msgid_info("Error pmu_1wire_get_vbus_uart_volt", 0);
#endif
...
static void pmu_1wire_init_to_out_of_case(pmu_1wire_bat_t bat)
{
    ...
    #endif
#else
    log_hal_msgid_info("Error pmu_1wire_init_to_out_of_case", 0);
#endif
}
...
#else
    log_hal_msgid_info("Error pmu_1wire_init_to_chg_mode", 0);
#endif
}
...
static void pmu_1wire_intr_to_chg_mode(pmu_1wire_bat_t bat)
{
    ...
    pmu_vio18_pull_up(PMU_ON);
#else
    log_hal_msgid_info("Error pmu_1wire_intr_to_chg_mode", 0);
#endif
}
...
static void pmu_1wire_com_mode_to_out_of_case(void)
{
    ...
    #endif
#else
    log_hal_msgid_info("Error pmu_1wire_com_mode_to_out_of_case", 0);
#endif
}
...
#else
    log_hal_msgid_info("Error pmu_1wire_chg_mode_to_com_mode", 0);
#endif
}
...
#else
    log_hal_msgid_info("Error pmu_1wire_pwr_saving_mode", 0);
#endif
}
