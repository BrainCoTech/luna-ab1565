...
typedef struct {
    ...
    struct {
        uint16_t  t_rising;         /**<The ISINK breath mode timing adjustment setting corresponding to the brightness level from darker to lighter(unit ms). */
        uint16_t  t_lightest;       /**<The duration time of the brightest level(unit ms). */
    }t1;
    struct {
        uint16_t  t_falling;        /**<The ISINK breath mode timing adjustment setting corresponding to the brightness level from lighter to darker(unit ms). */
