...
#ifndef __APP_VA_XIAOAI_ACTIVITY_H__
#define __APP_VA_XIAOAI_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_va_xiaoai_activity, and is only called by ui_shell when events are sent.
...
#endif /* __APP_VA_XIAOAI_ACTIVITY_H__ */
