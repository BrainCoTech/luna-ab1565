...
/**
* @brief      This function is enable/disable EMP temporarily, only agent, not write NVKEY.
*/
bool app_bt_emp_temp_enable(bool enable);

/**
 * @brief      This function is force disable EMP.
 * @param[in]  addr, the phone addr keeping connection.
 */
bool app_bt_emp_force_disable(const uint8_t *addr);

/**
 * @brief      This function is disconnect other EDR.
 * @param[in]  keep_addr, the phone addr keeping connection.
 */
