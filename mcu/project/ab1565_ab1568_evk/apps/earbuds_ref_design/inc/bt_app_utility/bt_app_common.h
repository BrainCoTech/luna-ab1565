...
typedef enum {
    ...
    BT_APP_COMMON_ULL_STREAM_RETRY_COUNT_10 = 10,   /* Latency is 40ms. */
...
#define BT_APP_COMMON_ULL_STREAM_RETRY_COUNT_FOR_MULTI_LINK_A2DP    (BT_APP_COMMON_ULL_STREAM_RETRY_COUNT_10)
