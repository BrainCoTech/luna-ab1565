...
# expand syslog buffer  JIRA: BTA-18268
AIR_SYSLOG_BUFFER_EXPAND_ENABLE       = y
AIR_SYSLOG_BUFFER_SIZE_12K_ENABLE     = y
...
#Enter RTC when charging full, only can enable it when MTK_SMART_CHARGER_ENABLE is n.
MTK_BATTERY_EOC_ENTER_RTC		      = y
...
# Do RHO when agent low battery, charger in, take out from ear, power off or disable BT
APPS_AUTO_TRIGGER_RHO               = y
# Do RHO press key on partner, need to turn off support_auto_rho in apps_config_features_dynamic_setting.c
...
AIR_PMU_CHARGER_PFM_ENABLE = n

#User triggered adaptive ANC
ifeq ($(MTK_ANC_ENABLE), y)
MTK_USER_TRIGGER_FF_CODE = $(strip $(SOURCE_DIR))/middleware/MTK/audio/user_trigger_adaptive_ff/readme.txt
