...
#endif
    APPS_LOG_MSGID_I(LOG_TAG" allow_le_audio, ret=%d state=%d support_lea_emp=%d",
                     3, ret, app_bt_conn_manager_ctx.state, support_lea_emp);
    return ret;
}
