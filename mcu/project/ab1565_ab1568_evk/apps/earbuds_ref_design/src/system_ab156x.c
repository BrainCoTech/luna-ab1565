 ...
 */
/**
 * File: system_ab156x.c
 *
 * Description: The file contains the core system initialize, such as cache, systick etc.
 *
 */
...
extern uint32_t hal_dvfs_get_cpu_frequency(void);
/* ----------------------------------------------------------------------------
   -- Core clock macros
   ---------------------------------------------------------------------------- */
...
{
    SystemCoreClock = hal_dvfs_get_cpu_frequency() * 1000;
}
