...
#define APP_MUSIC_UTILS "[Music]utils"
...
*/
bool app_music_idle_proc_aws_data_events(
...
#ifdef GSOUND_LIBRARY_ENABLE_CLOSE
/**
...
* @return     If return true, the current event cannot be handle by the next activity.
*/
bool app_music_proc_gsound_reject_actions(ui_shell_activity_t *self, bt_sink_srv_action_t sink_action);
#endif
...
* @return     If return true, the current event cannot be handle by the next activity.
*/
bool app_music_idle_proc_bt_sink_events(
    ui_shell_activity_t *self,
    uint32_t event_id,
    void *extra_data,
    size_t data_len);
...
* @return     If return true, the current event cannot be handle by the next activity.
*/
bool app_music_idle_proc_bt_cm_events(
    ui_shell_activity_t *self,
    uint32_t event_id,
    void *extra_data,
    size_t data_len);
