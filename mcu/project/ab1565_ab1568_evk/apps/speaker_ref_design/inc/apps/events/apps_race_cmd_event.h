...
typedef enum {
    APPS_RACE_CMD_SET_TOUCH_KEY_ENABLE = 0,
    APPS_RACE_CMD_SET_POWER_SAVING_CFG = 1,
    APPS_RACE_CMD_SET_IN_EAR_MUSIC_CFG = 2,
    APPS_RACE_CMD_SET_LINE_IN_JACK_STA = 3,
    APPS_RACE_CMD_SET_DETACH_MIC_JACK_STA = 4,
} apps_race_cmd_set_t;

typedef enum {
    APPS_RACE_CMD_GET_TOUCH_KEY_ENABLE = 0,
    APPS_RACE_CMD_GET_POWER_SAVING_CFG = 1,
    APPS_RACE_CMD_GET_IN_EAR_MUSIC_CFG = 2,
    APPS_RACE_CMD_GET_MFI_DEVICE_ID = 5,
} apps_race_cmd_get_t;
...
* @param[in]  cfg_type, see apps_race_cmd_set_t for details.
