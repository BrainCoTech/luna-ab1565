...
enum
{
    ...
    APP_GSOUND_ENABLING,
    APP_GSOUND_ENABLED,
    APP_GSOUND_DISABLING,
};

/**
 * @brief Notify Libgsound initial state when system power on.
 * @param[in] va_selected, true: GSound is enabled, false: GSound is disabled.
 */
