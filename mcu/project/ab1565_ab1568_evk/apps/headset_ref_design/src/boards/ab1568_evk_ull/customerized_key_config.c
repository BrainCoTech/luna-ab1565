...
#ifndef AIR_ROTARY_ENCODER_ENABLE
    {
        EINT_KEY_0,
        KEY_VOICE_UP,
...
#endif
#if defined(AIR_BT_ULTRA_LOW_LATENCY_ENABLE) && !defined(AIR_APP_ULL_GAMING_MODE_UI_ENABLE)
    {
        EINT_KEY_2,
        KEY_ULL_RECONNECT,
...
const apps_config_key_event_map_t temp_key_double_click_configs[] = {
    ...
    },
    {
        ...
        (1 << APP_DISCONNECTED) | (1 << APP_CONNECTABLE) | (1 << APP_CONNECTED) | (1 << APP_ULTRA_LOW_LATENCY_PLAYING)
#else
...
const apps_config_key_event_map_t temp_key_long_press3_configs[] = {
    ...
    },
    {
        ...
        | (1 << APP_STATE_FIND_ME) | (1 << APP_ULTRA_LOW_LATENCY_PLAYING) | (1 << APP_WIRED_MUSIC_PLAY) | (1 << APP_STATE_VA)
    },
};
...
const static apps_config_configurable_table_t default_configurable_table[] = {
    ...
    },
    {
        ...
        (1 << APP_CONNECTED) | (1 << APP_A2DP_PLAYING) | (1 << APP_ULTRA_LOW_LATENCY_PLAYING) | (1 << APP_WIRED_MUSIC_PLAY)
    },
    {
