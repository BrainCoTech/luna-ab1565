...
enum {
    ...
    VP_INDEX_SLEEP_MODE,
    VP_INDEX_NAP_MODE,
    VP_INDEX_TRAVEL_MODE,
    VP_INDEX_SELIEN_MODE,
    VP_INDEX_LOW_BATTERY,
    VP_INDEX_MUTE,
    VP_INDEX_INCOMING_CALL = VP_INDEX_MUTE,
    VP_INDEX_TWC_INCOMING_CALL = VP_INDEX_MUTE,
    VP_INDEX_CALL_REJECTED = VP_INDEX_MUTE,
    VP_INDEX_SUCCESSED = VP_INDEX_MUTE,
    VP_INDEX_PRESS= VP_INDEX_MUTE,
};
