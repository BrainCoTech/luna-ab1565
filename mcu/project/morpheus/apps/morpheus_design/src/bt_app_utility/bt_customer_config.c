...
static bt_cm_config_t s_cm_config = {
...
#if defined(AIR_BT_ULTRA_LOW_LATENCY_ENABLE) || defined(AIR_DUAL_CHIP_MIXING_MODE_ROLE_SLAVE_ENABLE)
    ...
    .link_loss_reconnect_profile = BT_CM_PROFILE_SERVICE_MASK_NONE
