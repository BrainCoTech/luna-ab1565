...
#ifdef AIR_MS_TEAMS_ENABLE
        ms_teams_telemetry_report_uint16_value(MS_TEAMS_TELEMETRY_BTN_PRESS_INFO, (0x20 << 8) | 0x0, true);
#endif
...
#ifdef AIR_MS_TEAMS_ENABLE
        ms_teams_telemetry_report_uint16_value(MS_TEAMS_TELEMETRY_BTN_PRESS_INFO, (0x20 << 8) | 0x1, true);
#endif
...
#ifdef AIR_MS_TEAMS_ENABLE
                if (s_muted) {
                    ms_teams_telemetry_report_uint16_value(MS_TEAMS_TELEMETRY_BTN_PRESS_INFO, (0x2F << 8) | 0x0, true);
                } else {
                    ms_teams_telemetry_report_uint16_value(MS_TEAMS_TELEMETRY_BTN_PRESS_INFO, (0x2F << 8) | 0x1, true);
                }
#endif
    ...
    switch (event_group) {
        ...
        case EVENT_GROUP_UI_SHELL_USB_HID_CALL:
            ...
            if (event_id == USB_HID_SRV_EVENT_CALL_MIC_MUTE) {
                ...
                s_muted = false;
            } else if (event_id <= USB_HID_SRV_EVENT_CALL_ACTIVATE) {
                s_muted = false;
            }
            break;
