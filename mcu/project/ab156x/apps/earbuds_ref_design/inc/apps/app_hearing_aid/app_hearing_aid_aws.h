...
bool app_hearing_aid_aws_send_operate_command(uint8_t code, uint8_t *buf, uint16_t buf_len, bool need_sync_operate, bool need_execute_locally, uint32_t delay_ms);
