...
#define APP_HEARING_AID_SYNC_EVENT_DEFAULT_TIMEOUT      500 // 500ms

#define APP_HEARING_AID_EVENT_SYNC_BASE                 0x2000

#define APP_HEARING_AID_EVENT_ID_AWS_BEGIN              0x0020
#define APP_HEARING_AID_EVENT_ID_AWS_SYNC_NVKEY         APP_HEARING_AID_EVENT_ID_AWS_BEGIN
#define APP_HEARING_AID_EVENT_ID_AWS_RACE_CMD_REQUEST   0x0021
#define APP_HEARING_AID_EVENT_ID_AWS_RACE_CMD_RESPONSE  0x0022
#define APP_HEARING_AID_EVENT_ID_AWS_OPERATE            0x0023
#define APP_HEARING_AID_EVENT_ID_AWS_NOTIFICATION       0x0024

#define APP_HEARING_AID_RESPONSE_MAX_LEN                102
...
bool app_hearing_aid_utils_get_mode_max_count(app_hear_through_request_t *request, uint8_t *respons, uint16_t *response_len);
...
#define APP_HEARING_AID_CHANGE_CAUSE_MIX_TABLE          0x0A
#define APP_HEARING_AID_CHANGE_CAUSE_REMOTE_USER_SWITCH 0x0B
