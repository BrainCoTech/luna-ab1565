...
app_hearing_aid_user_configuration_t user_config_from_nvkey;
app_hearing_aid_user_configuration_t user_config;

bool app_hearing_aid_storage_load()
{
    app_hearing_aid_user_configuration_t default_config;
...
void app_hearing_aid_storage_set_a2dp_mix_switch(bool a2dp_mix)
{
...
void app_hearing_aid_storage_set_sco_mix_switch(bool sco_mix)
{
...
void app_hearing_aid_storage_set_vp_mix_switch(bool vp_mix)
{
