...
#define AUDIO_ANC_CONTROL_PASS_THRU_TYPE_DEFAULT   (AUDIO_ANC_CONTROL_TYPE_PT_ADAP_FF|(0x170))
...
#define AUDIO_ANC_CONTROL_ADAPTIVE_PASS_THRU_FILTER_DEFAULT (AUDIO_ANC_CONTROL_TYPE_PT_ADAP_FF|(0x170))
...
typedef enum {
    ...
    AUDIO_ANC_CONTROL_TYPE_PT_ADAP_FF   = (1 << 16), /**< The adaptive pass-through type.   */
...
typedef struct audio_anc_control_misc_s {
    ...
    uint8_t  extend_bypass_control;                    /**< Extend use.   */
    int32_t  sidetone_scenario_gain;                   /**< Extend use.   */
    union {
        uint8_t  switch_filter_option;                  /**< Extend use.   */
...
/**
 * @brief     This function is used to enable or disable the seamless feature for switching filter.
 ...
 * @param[in] biquad_step_period is which want to divide step count for seamless switch total gain.
