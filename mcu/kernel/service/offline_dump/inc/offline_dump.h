...
/* FOTA region access control */
#ifdef MTK_FOTA_ENABLE
#if (PRODUCT_VERSION == 1552) || (PRODUCT_VERSION == 2552) || (PRODUCT_VERSION == 2822) || (PRODUCT_VERSION == 1565)
...
#endif /* END MTK_FOTA_VIA_RACE_CMD */
#endif /* END PRODUCT_VERSION */
#endif /* END MTK_FOTA_ENABLE */
