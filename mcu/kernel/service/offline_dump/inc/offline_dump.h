...
#else
#define OFFLINE_FOTA_ADDRESS FOTA_BASE
#endif
...
#define OFFLINE_REGION_MINI_DUMP_CELL_SIZE        ((FOTA_RESERVED_LENGTH - OFFLINE_REGION_SYSLOG_CELL_COUNT * OFFLINE_REGION_SYSLOG_CELL_SIZE) / OFFLINE_REGION_MINI_DUMP_CELL_COUNT)
