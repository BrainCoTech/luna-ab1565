...
typedef struct {
    __I uint32_t EINT_STA[2];               /* 0x00 EINT interrupt status register   */
    __O uint32_t EINT_INTACK[2];            /* 0x08 EINT interrupt acknowledge register */
    __I uint32_t EINT_EEVT[2];              /* 0x10 EINT wake-up event register */
    __O uint32_t EINT_EEVTACK[2];           /* 0x18 EINT wake-up event acknowledge register */
    EINT_DOMAIN_REGISTER_T EINT_MASK;          /*!< 0x20 EINT interrupt mask register */
    EINT_DOMAIN_REGISTER_T EINT_WAKEUP_MASK;   /*!< 0x40 EINT wakeup event mask register */
    EINT_DOMAIN_REGISTER_T EINT_SENS;          /*!< 0x60 EINT interrupt sensitive register  */
    EINT_DOMAIN_REGISTER_T EINT_DUALEDGE_SENS; /*!< 0x80 EINT interrupt dual edge sensitive register */
    EINT_DOMAIN_REGISTER_T EINT_POL;           /*!< 0xa0 EINT interrupt dual edge sensitive register */
    EINT_DOMAIN_REGISTER_T EINT_SOFT;          /*!< 0xc0 EINT software interrupt register */
