...
typedef enum {
    ...
    SOURCE_TYPE_MULTI_AUDIO_MIN,
    SOURCE_TYPE_AUDIO_MULTI_0 = SOURCE_TYPE_MULTI_AUDIO_MIN,
    SOURCE_TYPE_AUDIO_MULTI_1,
    SOURCE_TYPE_AUDIO_MULTI_2,
    SOURCE_TYPE_MULTI_AUDIO_MAX = SOURCE_TYPE_AUDIO_MULTI_2,
#endif
