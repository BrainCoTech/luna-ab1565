...
#define WIRELESS_MIC_RX_ULD_RESERVED_PROCESS_TIME       500 /* 0.5ms */
...
struct wireless_mic_rx_ul_handle_t {
    ...
    int16_t irq_compensation_cnt;
    int16_t irq_compensation_dir;
};
...
extern int32_t wireless_mic_rx_ul_get_irq_cp_samples(wireless_mic_rx_ul_handle_t *rx_handle, uint32_t bt_clk, uint16_t bt_phase);
