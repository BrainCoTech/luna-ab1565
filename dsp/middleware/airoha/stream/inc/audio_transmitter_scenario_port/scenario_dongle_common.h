...
#if defined(AIR_BLE_AUDIO_DONGLE_ENABLE) || defined(AIR_ULL_AUDIO_V2_DONGLE_ENABLE) || defined(AIR_BT_AUDIO_DONGLE_ENABLE) || defined(AIR_GAMING_MODE_DONGLE_ENABLE)
