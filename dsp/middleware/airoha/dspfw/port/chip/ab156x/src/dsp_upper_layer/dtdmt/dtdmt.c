 ...
 *
 */
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ BOOL DTDMT_ChkCallbackStatus(VOID)
{
    U8 i;
    for (i = 0 ; i < NO_OF_TDM_STREAM ; i++) {
 ...
 *
 */
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ VOID DTDMT_SuspendRequest(VOID *para)
{
    UNUSED(para);
    U32 mask;
