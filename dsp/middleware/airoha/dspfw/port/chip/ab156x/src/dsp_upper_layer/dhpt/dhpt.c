 ...
 * @Author : Brian <BrianChen@airoha.com.tw>
 */
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ BOOL DHPT_ChkCallbackStatus(VOID)
{
    U8 i;
    for (i = 0 ; i < NO_OF_HP_STREAM ; i++) {
 ...
 * @Author : Brian <BrianChen@airoha.com.tw>
 */
ATTR_TEXT_IN_RAM_FOR_MASK_IRQ VOID DHPT_SuspendRequest(VOID *para)
{
    UNUSED(para);
    U32 mask;
