...
ATTR_LOG_STRING_LIB  g_ANC_msg_id_string_135[] = LOG_DEBUG_PREFIX(anc) "[DMA]set_enable[0x%x][0x%x], CTL_0:0x%08x";
...
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_1[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Full Adapt ANC]Initialize ANC_PARA(%d)(%d)(%d)(%d)(%d)(%d), debug mode(%d), Lib mode(%d)";
