...
bool stream_function_clock_skew_a2dp_initialize(void *para)
{
    ...
    if(stream_ptr->source->param.n9_a2dp.codec_info.codec_cap.type == BT_A2DP_CODEC_SBC || stream_ptr->source->param.n9_a2dp.codec_info.codec_cap.type == BT_A2DP_CODEC_AAC){
