...
typedef bool (*CusFunc_initialize)(void*);
...
extern bool framesize_adjustor_sample_Fun1_initialize(void* para);
extern bool framesize_adjustor_sample_Fun2_initialize(void* para);
