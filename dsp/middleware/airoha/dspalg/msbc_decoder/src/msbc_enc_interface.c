...
bool stream_codec_encoder_msbc_process(void *para)
{
    ...
    LOG_AUDIO_DUMP((U8 *)InBuf, encode_frames * MSBC_ENCODE_FRAME_SIZE_7_5, AUDIO_BT_SRC_DONGLE_DL_ENC_IN);
    ...
    LOG_AUDIO_DUMP((U8 *)OutBuf, 60 * encode_frames, AUDIO_BT_SRC_DONGLE_DL_ENC_OUT);
#endif
