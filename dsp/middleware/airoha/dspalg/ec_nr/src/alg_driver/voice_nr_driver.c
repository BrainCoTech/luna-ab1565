...
#if defined(AIR_AI_NR_PREMIUM_270K_ENABLE) && defined(ROM_TABLE_ADDR_IGO_AINR_270K)
    IGO_NR_Init(g_voice_ecnr_nr_para->ScratchMemory, ROM_TABLE_ADDR_IGO_AINR_270K, (uint32_t *)g_voice_ecnr_nr_para->ResKey, &g_voice_ecnr_nr_para->ff_eq, &g_voice_ecnr_nr_para->fb_eq, (uint8_t)igo_mode, baud_mode);
#elif defined(AIR_AI_NR_PREMIUM_80K_ENABLE) && defined(ROM_TABLE_ADDR_IGO_AINR_80K)
