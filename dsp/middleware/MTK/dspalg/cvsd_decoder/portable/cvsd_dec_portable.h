...
#define _CVSD_Decoder_Init ((p_CVSD_Decoder_Init_t)cvsd_dec_decoder_export_parameters[0])
#define _CVSD_Decoder ((p_CVSD_Decoder_t)cvsd_dec_decoder_export_parameters[1])
