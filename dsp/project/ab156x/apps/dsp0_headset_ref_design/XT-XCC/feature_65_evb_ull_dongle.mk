...
# This option is used to enable LHDC codec.
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
...
# This option is to enable BT source dongle scenario.
# It must be turned on/off for both DSP and MCU side AIR_BT_SOURCE_ENABLE option, otherwise, it will not work.
...
# This option is used to enable/disable SWB.
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
AIR_BT_BLE_UL_SWB_ENABLE = n
...
# It must be set to the same value for both DSP and MCU, otherwise, it will not work.
# Usage: NONE, LINE_IN, I2S_MST_IN, I2S_SLV_IN, LINE_IN_I2S_MST_IN, LINE_IN_I2S_SLV_IN
...
# It must be set to the same value for both DSP and MCU, otherwise, it will not work.
# Usage: NONE, LINE_OUT, I2S_MST_OUT, I2S_SLV_OUT, LINE_IN_I2S_MST_OUT, LINE_IN_I2S_SLV_OUT
