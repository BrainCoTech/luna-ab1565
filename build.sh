...
for d in $(cd mcu/project/ ;ls -d */);
do
    if [ -f mcu/tools/mapping_proj/mapping_proj_${d::-1}.cfg ]; then
        #echo "File mcu/tools/mapping_proj/mapping_proj_${d::-1}.cfg exist!"
        source mcu/tools/mapping_proj/mapping_proj_${d::-1}.cfg
    fi
done
