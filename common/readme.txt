...
Chips of each product line are shown as below
    • Airoha IoT SDK for BT Audio: AB1565/AB1568/AB157x/AB158x

1. Getting started
   Follow the instructions at <sdk_root>/mcu/doc/Airoha_IoT_SDK_for_BT_Audio_Get_Started_Guide.pdf
   for the description of content in the folder.

2. Folder structure
  \doc                      ->  Includes SDK related documentation.
